...
Final visual review: increased separation below the large numeric score to clear comma descenders in both PNG formats, and matched the established social-preview cream/green palette. Cross-checked the completed leaderboard and share component against the live Range Rescue module: controls and panels use the site's white/slate surfaces, dark buttons and inherited typography; golf/card imagery retains green accents. Re-rendered and inspected the actual drawing module at full export resolution and the completed component at 320px/390px/1280px widths. Updated `scorecard-feed.png`, `scorecard-story.png`, `desktop-scorecard.png`, and `mobile-scorecard.png`. Temporary local rendering fixtures were removed after review.
