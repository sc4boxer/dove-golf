...
import { FatIronsWizard } from "@/components/clinic/FatIronsWizard";
import { LikelihoodBars } from "@/components/clinic/LikelihoodBars";
import { RangePlan } from "@/components/clinic/RangePlan";
import { evaluateFatIrons, fatIronsLeverLabel } from "@/lib/clinic/problems/fatIrons";
import { loadClinicSessions, saveClinicSession } from "@/lib/clinic/storage";
import { ClinicSession, FatIronsInputs } from "@/lib/clinic/types";

function defaults(): Partial<FatIronsInputs> {
  return { fatSeverity: undefined, turfCondition: undefined, ballPosition: undefined, pressurePattern: undefined, loftPattern: undefined, tempoTransition: undefined };
}

export default function FatIronsPage() {
  const [inputs, setInputs] = useState<Partial<FatIronsInputs>>(defaults());
  const [result, setResult] = useState<ReturnType<typeof evaluateFatIrons> | null>(null);
