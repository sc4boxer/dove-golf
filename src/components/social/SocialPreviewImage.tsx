...
export const SOCIAL_PREVIEW_ALT =
  `Dove Golf — ${SITE_SLOGAN} A dotted ball flight crosses a quiet green background.`;
...
export function SocialPreviewImage() {
  return (
    ...
    >
      ...
      <div style={{ position: "absolute", left: 62, top: 170, display: "flex", flexDirection: "column", width: 660 }}>
        <div style={{ display: "flex", flexDirection: "column", fontSize: 64, fontWeight: 700, letterSpacing: "-3px", lineHeight: 1.02 }}>
          {SITE_SLOGAN}
        </div>
